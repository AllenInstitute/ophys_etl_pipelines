...
from ophys_etl.modules.segmentation.merge.characteristic_timeseries import (
    _update_timeseries_lookup,
    _update_timeseries_lookup_per_pix,
...
@pytest.mark.parametrize('filter_fraction, n_processors',
                         [(0.2, 2), (0.2, 3),
                          (0.3, 2), (0.3, 3)])
def test_full_update_timeseries(small_rois,
                                large_rois,
                                filter_fraction,
                                n_processors):
    video_lookup = {}
    ...
    result = update_timeseries_lookup(
                   merger_list,
                   {},
                   video_lookup,
                   filter_fraction,
