...
class TestModelUtils:
    ...
    def setup_class(cls):
        ...
        with open(
            Path(__file__).parent.parent
            / "resources"
            / "sagemaker_describe_training_job.pkl",
            "rb",
        ) as f:
    ...
    def test_download_trained_model(
        self, __, mock_search_runs, mock_boto3_client
    ):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            class DummyBoto3Client:
                ...
                def describe_training_job(TrainingJobName):
                    ...
                    res["ModelArtifacts"]["S3ModelArtifacts"] = re.sub(
                        r"fold-\d",
                        f"fold-{fold}",
            ...
            download_trained_model(
                mlflow_run_name="CV-1678301354", model_dest=model_dest
            )
            ...
            assert set(os.listdir(model_dest.path)) == set(
                [f"{i}_model.pt" for i in range(n_folds)]
            )
