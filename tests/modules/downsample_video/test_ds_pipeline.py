...
import pathlib
import tempfile
from ophys_etl.modules.downsample_video.single_video import (
    VideoDownsampler)

from ophys_etl.modules.downsample_video.side_by_side_video import (
...
def test_single_video_downsampling(
    ...
    video_path = str(ds_video_path_fixture.resolve().absolute())
